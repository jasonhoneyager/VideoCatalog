...
//     o For example, if we want to create an aggregated genre Romantic Comedy, all the film titles 
...
//-    Show the program in use. Essentially, there needs to be data, run the program, and print to the console 
//     to show that the program works.
//     There are plenty of opportunities to implement the tools you learned this week. With that said, remember 
